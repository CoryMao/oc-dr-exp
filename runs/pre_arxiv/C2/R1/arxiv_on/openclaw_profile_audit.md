...
profile: pre-arxiv-c2-r1-on
timestamp_utc: 2026-06-04T12:02:30Z

## Version
OpenClaw 2026.5.28 (e932160)

## Config File
~/.openclaw-pre-arxiv-c2-r1-on/openclaw.json

## Config Validate
Config valid: ~/.openclaw-pre-arxiv-c2-r1-on/openclaw.json

## MCP List
MCP servers (/Users/kaichengmao/.openclaw-pre-arxiv-c2-r1-on/openclaw.json):
- arxiv
