...
profile: pre-arxiv-c4-r1-off
timestamp_utc: 2026-06-04T12:04:19Z

## Version
OpenClaw 2026.5.28 (e932160)

## Config File
~/.openclaw-pre-arxiv-c4-r1-off/openclaw.json

## Config Validate
Config valid: ~/.openclaw-pre-arxiv-c4-r1-off/openclaw.json

## MCP List
No MCP servers configured in /Users/kaichengmao/.openclaw-pre-arxiv-c4-r1-off/openclaw.json. Add one with openclaw --profile pre-arxiv-c4-r1-off mcp set <name> '{"command":"uvx","args":["context7-mcp"]}'.

## MCP Show
MCP servers (/Users/kaichengmao/.openclaw-pre-arxiv-c4-r1-off/openclaw.json):
{}
