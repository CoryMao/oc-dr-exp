...
profile: main-m1-memory-on
timestamp_utc: 2026-06-04T20:00:46Z

## Version
OpenClaw 2026.5.28 (e932160)

## Config File
~/.openclaw-main-m1-memory-on/openclaw.json

## Config Validate
Config valid: ~/.openclaw-main-m1-memory-on/openclaw.json

## MCP List
MCP servers (/Users/kaichengmao/.openclaw-main-m1-memory-on/openclaw.json):
- arxiv
- refchecker
...
MCP servers (/Users/kaichengmao/.openclaw-main-m1-memory-on/openclaw.json):
{
  "arxiv": {
    ...
    "args": [
      "/Users/kaichengmao/Desktop/Project2/evaluation/pre_experiments/scripts/openclaw_arxiv_mcp_safe.py",
      "--storage-path",
      "/Users/kaichengmao/.openclaw-main-m1-memory-on/workspace/arxiv_mcp_papers"
    ],
    "env": {
      "PYTHONUNBUFFERED": "1",
  ...
  "refchecker": {
    "command": "/Library/Frameworks/Python.framework/Versions/3.13/bin/mcp-refchecker",
    "args": [],
    "env": {
      "PYTHONUNBUFFERED": "1",
      "NO_PROXY": "arxiv.org,export.arxiv.org,localhost,127.0.0.1"
...
│ disabled │ 🖼️ canvas                 │ Present HTML on connected OpenClaw node canvases,          │ openclaw-bundled │
│          │                           │ navigate/eval/snapshot, and debug canvas host URLs.        │                  │
...
│ disabled │ 🧩 coding-agent           │ Delegate coding work to Codex, Claude Code, or OpenCode    │ openclaw-bundled │
│          │                           │ as background workers; not simple edits or read-only code  │                  │
│          │                           │ lookup.                                                    │                  │
...
│ disabled │ 🎮 gog                    │ Google Workspace CLI for Gmail, Calendar, Drive,           │ openclaw-bundled │
...
│ disabled │ 🖼️ meme-maker             │ Search meme templates, suggest formats, and generate       │ openclaw-bundled │
│          │                           │ local or hosted image memes.                               │                  │
...
│ disabled │ 💎 obsidian               │ Work with Obsidian vaults using the official obsidian      │ openclaw-bundled │
│          │                           │ CLI: read/search/create/edit notes, tasks, links,          │                  │
│          │                           │ properties, plugins.                                       │                  │
│ disabled │ obsidian-vault-maintainer │ Maintain an Obsidian-friendly memory wiki vault with       │ openclaw-extra   │
│          │                           │ wikilinks, frontmatter, and official Obsidian CLI          │                  │
│          │                           │ awareness.                                                 │                  │
...
│          │                           │ engine.                                                    │                  │
│ disabled │ 🛵 ordercli               │ Foodora-only CLI for checking past orders and active       │ openclaw-bundled │
...
│ disabled │ 💬 slack                  │ Slack tool actions: send/read/edit/delete messages,        │ openclaw-bundled │
│          │                           │ react, pin/unpin, list pins/reactions/emoji, member info.  │                  │
│ disabled │ 🌊 songsee                │ Generate spectrograms and feature-panel visualizations     │ openclaw-bundled │
│          │                           │ from audio with the songsee CLI.                           │                  │
│ disabled │ 🔊 sonoscli               │ Control Sonos speakers (discover/status/play/volume/       │ openclaw-bundled │
│          │                           │ group).                                                    │                  │
...
│          │                           │ tasks.                                                     │                  │
│ disabled │ 📥 taskflow-inbox-triage  │ Example TaskFlow pattern for inbox triage, intent          │ openclaw-bundled │
│          │                           │ routing, waiting on replies, and later summaries.          │                  │
...
│ disabled │ 📋 trello                 │ Manage Trello boards, lists, and cards via the Trello      │ openclaw-bundled │
│          │                           │ REST API.                                                  │                  │
...
│ disabled │ 📱 wacli                  │ Send third-party WhatsApp messages or sync/search          │ openclaw-bundled │
│          │                           │ WhatsApp history via wacli, not normal active chats.       │                  │
...
│ disabled │ wiki-maintainer           │ Maintain the OpenClaw memory wiki vault with               │ openclaw-extra   │
│          │                           │ deterministic pages, managed blocks, and source-backed     │                  │
│          │                           │ updates.                                                   │                  │
│ disabled │ 🐦 xurl                   │ xurl CLI for authenticated X posts, replies, reads/        │ openclaw-bundled │
│          │                           │ search, DMs, media upload, followers, auth status, or raw  │                  │
│          │                           │ v2 API calls.                                              │                  │
└──────────┴───────────────────────────┴────────────────────────────────────────────────────────────┴──────────────────┘
