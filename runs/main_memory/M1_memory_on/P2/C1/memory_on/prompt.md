...
- M5: source=P1_C1 case=C1 item=ref_E tag=E issue=none action=correct_metadata; ref_E [E] Title, authors, year, arXiv ID all verified. Venue is NeurIPS 2024, not just arXiv preprint. Repair action: correct_metadata.
- M6: source=P1_C1 case=C1 item=ref_C tag=C issue=none action=correct_metadata; ref_C [C] Title, authors, year, arXiv ID all verified. Venue is ACL 2025, not just arXiv preprint. Repair action: correct_metadata.
...
```text
input_papers/case1/A Self-Improving Coding Agent.pdf
input_papers/case1/Trae Agent_An LLM-based Agent for Software Engineering with Test-time Scaling.pdf
input_papers/case1/LLM Agents Making Agent Tools.pdf
```
...
```json
{"case_id":"C1","run_id":"P2_C1","tool_called_refchecker":"yes_or_no","num_references_checked":0,"num_claim_pairs_checked":0,"num_issues_found":0,"num_revisions_made":0}
```
