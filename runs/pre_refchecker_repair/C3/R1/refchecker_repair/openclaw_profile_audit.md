...
profile: pre-refchecker-c3-r1-repair
timestamp_utc: 2026-06-04T17:23:55Z

## Version
OpenClaw 2026.5.28 (e932160)

## Config File
~/.openclaw-pre-refchecker-c3-r1-repair/openclaw.json

## Config Validate
Config valid: ~/.openclaw-pre-refchecker-c3-r1-repair/openclaw.json

## MCP List
MCP servers (/Users/kaichengmao/.openclaw-pre-refchecker-c3-r1-repair/openclaw.json):
- arxiv
- refchecker
...
MCP servers (/Users/kaichengmao/.openclaw-pre-refchecker-c3-r1-repair/openclaw.json):
{
  "arxiv": {
    ...
    "args": [
      ...
      "--storage-path",
      "/Users/kaichengmao/.openclaw-pre-refchecker-c3-r1-repair/workspace/arxiv_mcp_papers"
    ],
    "env": {
      "PYTHONUNBUFFERED": "1",
